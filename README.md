...
این اسکریپت به‌طور خودکار گزینه‌ی خیلی خوب (یا هر گزینه‌ای که بخواید!) را در فرم‌ نظرسنجی سایت آموزش‌یار (مثل ارزیابی اساتید) انتخاب می‌کند و فرایند پر کردن فرم را بسیار سریع‌تر و راحت‌تر می‌سازد. 😁👊
